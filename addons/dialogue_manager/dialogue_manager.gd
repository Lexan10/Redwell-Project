...
const ExampleBalloon = preload("res://addons/dialogue_manager/example_balloon/example_balloon1.gd")
...
func show_example_dialogue_balloon(title: String, local_resource: DialogueResource = null, extra_game_states: Array = []) -> void:
	...
	if dialogue_line != null:
		var balloon = preload("res://addons/dialogue_manager/example_balloon/example_balloon1.tscn").instance()
